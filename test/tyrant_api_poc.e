note
	description: "{TYRANT_API_POC} is network interface to the DBM called Tokyo Cabinet"
	author: ""
	date: "$Date$"
	revision: "$Revision$"
...
create
	make, make_client_by_host_and_port
...
feature -- Initialization
	...
	make_client_by_host_and_port ( a_port : INTEGER; a_host : STRING)
